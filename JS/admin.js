...
async function loadProducts() {
  try {
    const tbody = document.getElementById("products-tbody");
    if (tbody) tbody.innerHTML = '<tr><td colspan="4" style="text-align: center; padding: 60px;"><div class="loading"><div class="spinner"></div>Loading...</div></td></tr>';
    ...
    if (snapshot.empty) {
      if (tbody) {
        tbody.innerHTML = '<tr><td colspan="4" style="text-align: center; padding: 60px; color: #94a3b8;"><i class="fas fa-box-open" style="font-size: 64px;"></i><h3>No Products</h3><p>Add your first product above</p></td></tr>';
      }
    ...
    const tbody = document.getElementById("products-tbody");
    if (tbody) tbody.innerHTML = '<tr><td colspan="4" style="text-align: center; padding: 40px; color: #ef4444;">Products failed to load</td></tr>';
  }
}
